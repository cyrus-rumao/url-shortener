import { UrlServiceError, createShortUrlService, deleteUserShortUrlService, getUserShortUrlsService, resolveOriginalUrlBySlugService, } from "@/services/url.service.js";
...
export const createShortUrl = async (req, res) => {
    try {
        ...
        const createdUrl = await createShortUrlService(input, req.user ? req.user.id : null, getRequestOrigin(req));
